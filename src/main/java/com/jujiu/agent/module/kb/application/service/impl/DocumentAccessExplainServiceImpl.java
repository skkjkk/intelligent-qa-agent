...
import com.jujiu.agent.module.kb.application.service.DocumentAccessExplainService;
...
public class DocumentAccessExplainServiceImpl implements DocumentAccessExplainService {
     ...
     */
    public DocumentAccessExplainServiceImpl(KbDocumentMapper kbDocumentMapper,
    ...
    private boolean hasDirectUserReadLikePermission(Long documentId, Long userId) {
        ...
        Long count = kbDocumentAclMapper.selectCount(
    ...
    private boolean isGroupSharedVisible(Long documentId, Long userId) {
        ...
        // 3. 查询文档-用户组关联记录数
        Long count = kbDocumentGroupMapper.selectCount(
