...
import com.jujiu.agent.module.kb.api.response.KbDocumentAclGrantItemResponse;
...
import com.jujiu.agent.module.kb.domain.entity.KbGroup;
...
import com.jujiu.agent.module.kb.infrastructure.mapper.KbGroupMapper;
import com.jujiu.agent.module.kb.application.service.DocumentAclService;
import com.jujiu.agent.module.kb.application.service.DocumentSharingQueryService;
...
public class DocumentSharingQueryServiceImpl implements DocumentSharingQueryService {
     ...
     * 构造方法。
     *
     * @param kbDocumentMapper      文档持久化仓库
     * @param kbDocumentAclMapper   文档 ACL 持久化仓库
     * @param kbDocumentGroupMapper 文档-用户组关联持久化仓库
     * @param kbGroupMapper         用户组持久化仓库
     * @param documentAclService        文档 ACL 服务
     */
    public DocumentSharingQueryServiceImpl(KbDocumentMapper kbDocumentMapper,
                                           KbDocumentAclMapper kbDocumentAclMapper,
                                           KbDocumentGroupMapper kbDocumentGroupMapper,
                                           KbGroupMapper kbGroupMapper,
        ...
        this.kbGroupMapper = kbGroupMapper;
    ...
    public KbDocumentSharingOverviewResponse getSharingOverview(Long userId, Long documentId) {
        ...
        // 2. 查询文档的所有 ACL 授权记录
        List<KbDocumentAcl> aclList = kbDocumentAclMapper.selectList(
        ...
        List<KbDocumentGroupResponse> sharedGroups = kbDocumentGroupMapper.selectList(
    ...
    private KbDocumentGroupResponse toDocumentGroupResponse(KbDocumentGroup relation) {
        // 1. 查询关联的用户组详细信息
        KbGroup group = kbGroupMapper.selectById(relation.getGroupId());
