package com.jujiu.agent.module.auth.infrastructure.config;

import com.jujiu.agent.infrastructure.config.CorsProperties;
import com.jujiu.agent.module.auth.infrastructure.security.JwtAuthenticationFilter;
