...
public class GroupMembershipServiceImpl implements GroupMembershipService {
     ...
     * 构造方法。
     *
     * @param kbGroupMemberRepository 知识库组成员仓储
     */
    public GroupMembershipServiceImpl(KbGroupMemberRepository kbGroupMemberRepository) {
    ...
    public boolean isMember(Long userId, Long groupId) {
        ...
        // 2. 查询匹配的用户-组关联记录数
        Long count = kbGroupMemberRepository.selectCount(
                new LambdaQueryWrapper<KbGroupMember>()
                        .eq(KbGroupMember::getUserId, userId)
