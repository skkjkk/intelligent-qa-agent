...
public class DocumentProcessFailureHandler {
    ...
    private final KbDocumentProcessLogRepository processLogRepository;

    public DocumentProcessFailureHandler(KbDocumentRepository documentRepository,
                                         KbDocumentProcessLogRepository processLogRepository) {
